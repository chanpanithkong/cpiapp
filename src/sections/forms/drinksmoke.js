...
const DrinksmokeForm = () => {
  ...
  return (
    <MainCard title="ភេសជ្ជៈ​ និងថ្នាំជក់">
      <form onSubmit={formik.handleSubmit}>
        <Grid container spacing={3}>
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="email">ទឹកសុទ្ធវីតាល់</InputLabel>
              <TextField
                fullWidth
                id="emailInstant"
                name="emailInstant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise2">ស្រាបៀរអង្គរ</InputLabel>
              <TextField
                fullWidth
                id="rise2Instant"
                name="rise2Instant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise3">ទឹកក្រូចកូកាកូឡា</InputLabel>
              <TextField
                fullWidth
                id="rise3Instant"
                name="rise3Instant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise4">ទឹកផ្លែឈើ</InputLabel>
              <TextField
                fullWidth
                id="rise4Instant"
                name="rise4Instant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise3">ភេសជ្ជៈប៉ូវកំលាំង (គោជល់ បាកាស...)</InputLabel>
              <TextField
                fullWidth
                id="rise3Instant"
                name="rise3Instant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise3">ស្រាបិទ</InputLabel>
              <TextField
                fullWidth
                id="rise3Instant"
                name="rise3Instant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise4">កាហ្វេទឹកដោះគោទឹកកក</InputLabel>
              <TextField
                fullWidth
                id="rise4Instant"
                name="rise4Instant"
          ...
          <Grid item xs={8} lg={4}>
            <Stack spacing={1}>
              <InputLabel htmlFor="rise4">បារី</InputLabel>
              <TextField
                fullWidth
                id="rise4Instant"
                name="rise4Instant"
