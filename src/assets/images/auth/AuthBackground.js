...
import logoDark from 'assets/images/authbgnbc.png';
import logo from 'assets/images/authbgnbc.png';
...
const AuthBackground = () => {
  ...
  return (
    <Box sx={{ position: 'absolute', filter: 'blur(10px)', zIndex: -1, bottom: 5 }}>
      <img src={theme.palette.mode === 'dark' ? logoDark : logo} alt="nbc-cpi" width="400" />
