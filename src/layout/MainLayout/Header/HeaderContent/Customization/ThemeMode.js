...
import { CardMedia, FormControlLabel, FormGroup, Grid, Radio, RadioGroup, Stack, Typography } from '@mui/material';
    ...
    <RadioGroup row aria-label="payment-card" name="payment-card" value={mode} onChange={handleModeChange}>
      <Grid container spacing={1.75} sx={{ ml: 0 }}>
        <Grid item>
          ...
          />
          <FormGroup>
            <FormControlLabel control={<MaterialUISwitch sx={{ m: 1 }} checked={mode} />} label="Night Mode" />
          </FormGroup>
        </Grid>
        <Grid item>
          <FormControlLabel
